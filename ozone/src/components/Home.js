      ...
      <div  className={styles.homeWrapper}>
        <div className={styles.filters}>
          <div className={styles.filterRoute}>
            ...
            <div className={styles.filterBox}><p>name:</p><input placeholder='Search By Name' type='text' value={undefined} ref={input => this._name = input}></input></div>
          ...
          <div onClick={()=> this.props.dispatch(handleSubmitClick(this._name.value.toLowerCase(), this._type.value, this._grade.value, routes))} className={styles.filterRouteButton}><p>Search Routes</p></div>
        </div></Link>
